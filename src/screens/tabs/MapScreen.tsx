...
export default function MapScreen() {
  ...
  const animateTo = (nextRegion: Region) => {
    const normalizedRegion: Region = {
      ...
      latitudeDelta: Math.min(Math.max(nextRegion.latitudeDelta, MIN_DELTA), MAX_DELTA),
      longitudeDelta: Math.min(Math.max(nextRegion.longitudeDelta, MIN_DELTA), MAX_DELTA),
    };

    setRegion(normalizedRegion);
    mapRef.current?.animateToRegion(normalizedRegion, 300);
  };
                ...
                <>
                  ...
                  <TouchableOpacity
                    ...
                    onPress={() => {
                      ...
                      setSelected(null);
                      navigation.navigate('PlaceDetail', { place: current });
                    }}
                  >
...
const styles = StyleSheet.create({
  ...
  header: {
    ...
    paddingHorizontal: isVerySmall ? 14 : isSmall ? 16 : 20,
    paddingTop: isVerySmall ? 8 : 10,
    paddingBottom: isVerySmall ? 10 : 16,
    backgroundColor: 'rgba(13,27,75,0.92)',
  },
  headerTitle: {
    color: COLORS.white,
  ...
  controlBtn: {
    ...
    borderRadius: 999,
    backgroundColor: 'rgba(13,27,75,0.88)',
    borderWidth: 1,
